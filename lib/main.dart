...
void main() => runApp(MaterialApp(title: 'Geeky Math',
  theme: ThemeData(
    ...
    dialogBackgroundColor: Colors.teal.shade900,
...
class LoginScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    loginScreen = Container(child: Column(children: [title, Flexible(child: ListView(shrinkWrap: true, children: <Widget>[Container(child: username, padding: EdgeInsets.all(betweenMargins),), Container(child: password, padding: EdgeInsets.all(betweenMargins)), Container(child: login, padding: EdgeInsets.all(betweenMargins))],))], crossAxisAlignment: CrossAxisAlignment.center, mainAxisAlignment: MainAxisAlignment.center,), padding: EdgeInsets.all(16));
    signUpScreen = Container(child: Column(children: [title, Flexible(child: ListView(shrinkWrap: true, children: <Widget>[Container(child: usernameSignUp, padding: EdgeInsets.all(betweenMargins)), Container(child: passwordSignUp, padding: EdgeInsets.all(betweenMargins)), Container(child: password2, padding: EdgeInsets.all(betweenMargins)), Container(child: firstname, padding: EdgeInsets.all(betweenMargins)), Container(child: lastname, padding: EdgeInsets.all(betweenMargins)), Container(child: signUp, padding: EdgeInsets.all(betweenMargins))],))], crossAxisAlignment: CrossAxisAlignment.center, mainAxisAlignment: MainAxisAlignment.center,), padding: EdgeInsets.all(16));
